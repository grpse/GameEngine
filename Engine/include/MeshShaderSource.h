...
vec4 CalculateDirectionalSpecularColor(Light light) {
...
void main() {
	...
	DiffuseColor += CalculateDirectionalDiffuseColor(directional);
	SpecularColor += CalculateDirectionalSpecularColor(directional);
/*
